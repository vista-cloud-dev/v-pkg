...
func TestRunVerify(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZSKEL*1.0*1", []string{"ZZSKEL"}, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestRunVerify_ParamDef(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "VSLBASE*1.0*1",
		[]string{"VSLCFG"}, []string{"VSL GREETING"}, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunVerify_Option(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZOPT*1.0*1",
		[]string{"ZZOPTRT"}, nil, []string{"ZZOPT RUN ROUTINE"}, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunVerify_Key(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZKEY*1.0*1",
		[]string{"ZZKEYRT"}, nil, nil, []string{"ZZKEY MANAGER"}, nil, nil, nil)
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunVerify_Protocol(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZPROTO*1.0*1",
		[]string{"ZZPRORT"}, nil, nil, nil, []string{"ZZPROTO ACTION"}, nil, nil)
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunVerify_RPC(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZRPC*1.0*1",
		[]string{"ZZRPCRT"}, nil, nil, nil, nil, []string{"ZZRPC ECHO"}, nil)
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunVerify_File(t *testing.T) {
	...
	res, err := runVerify(context.Background(), fakeClient(f), "ZZVSLFS*1.0*1", nil, nil, nil, nil, nil, nil, []string{"999000"})
	if err != nil {
		t.Fatalf("runVerify: %v", err)
	}
...
func TestRunUninstall(t *testing.T) {
	...
	res, err := runUninstall(context.Background(), fakeClient(f), "ZZSKEL*1.0*1", []string{"ZZSKEL"}, nil, nil, nil, nil, nil, nil)
	if err != nil {
