...
func TestVerifyScript(t *testing.T) {
	got := VerifyScript("ZZSKEL*1.0*1", []string{"ZZSKEL"}, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_ParamDef(t *testing.T) {
	got := VerifyScript("VSLBASE*1.0*1", []string{"VSLCFG"}, []string{"VSL GREETING"}, nil, nil, nil, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_Option(t *testing.T) {
	got := VerifyScript("ZZOPT*1.0*1", []string{"ZZOPTRT"}, nil, []string{"ZZOPT RUN ROUTINE"}, nil, nil, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_Key(t *testing.T) {
	got := VerifyScript("ZZKEY*1.0*1", []string{"ZZKEYRT"}, nil, nil, []string{"ZZKEY MANAGER"}, nil, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_Protocol(t *testing.T) {
	got := VerifyScript("ZZPROTO*1.0*1", []string{"ZZPRORT"}, nil, nil, nil, []string{"ZZPROTO ACTION"}, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_RPC(t *testing.T) {
	got := VerifyScript("ZZRPC*1.0*1", []string{"ZZRPCRT"}, nil, nil, nil, nil, []string{"ZZRPC ECHO"}, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_MailGroup(t *testing.T) {
	got := VerifyScript("ZZMG*1.0*1", []string{"ZZMGRT"}, nil, nil, nil, nil, nil, []string{"ZZMG ALERTS"}, nil, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_ListTemplate(t *testing.T) {
	got := VerifyScript("ZZLM*1.0*1", []string{"ZZLMRT"}, nil, nil, nil, nil, nil, nil, []string{"ZZLM PATIENTS"}, nil, nil)
	for _, want := range []string{
...
func TestVerifyScript_HelpFrame(t *testing.T) {
	got := VerifyScript("ZZHF*1.0*1", []string{"ZZHFRT"}, nil, nil, nil, nil, nil, nil, nil, []string{"ZZHF-MAIN"}, nil)
	for _, want := range []string{
...
func TestVerifyScript_File(t *testing.T) {
	got := VerifyScript("ZZVSLFS*1.0*1", nil, nil, nil, nil, nil, nil, nil, nil, nil, []string{"999000"})
	for _, want := range []string{
		`$D(^DD(999000,0))`,
...
func TestUninstallScript(t *testing.T) {
	got := UninstallScript("ZZSKEL*1.0*1", []string{"ZZSKEL"}, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	for _, want := range []string{
...
func TestUninstallScript_ParamDef(t *testing.T) {
	got := UninstallScript("VSLBASE*1.0*1", []string{"VSLCFG"}, []string{"VSL GREETING"}, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestUninstallScript_Option(t *testing.T) {
	got := UninstallScript("ZZOPT*1.0*1", []string{"ZZOPTRT"}, nil, []string{"ZZOPT RUN ROUTINE"}, nil, nil, nil, nil, nil, nil, nil)
...
func TestUninstallScript_Key(t *testing.T) {
	got := UninstallScript("ZZKEY*1.0*1", []string{"ZZKEYRT"}, nil, nil, []string{"ZZKEY MANAGER"}, nil, nil, nil, nil, nil, nil)
...
func TestUninstallScript_Protocol(t *testing.T) {
	got := UninstallScript("ZZPROTO*1.0*1", []string{"ZZPRORT"}, nil, nil, nil, []string{"ZZPROTO ACTION"}, nil, nil, nil, nil, nil)
...
func TestUninstallScript_RPC(t *testing.T) {
	got := UninstallScript("ZZRPC*1.0*1", []string{"ZZRPCRT"}, nil, nil, nil, nil, []string{"ZZRPC ECHO"}, nil, nil, nil, nil)
...
func TestUninstallScript_MailGroup(t *testing.T) {
	got := UninstallScript("ZZMG*1.0*1", []string{"ZZMGRT"}, nil, nil, nil, nil, nil, []string{"ZZMG ALERTS"}, nil, nil, nil)
...
func TestUninstallScript_ListTemplate(t *testing.T) {
	got := UninstallScript("ZZLM*1.0*1", []string{"ZZLMRT"}, nil, nil, nil, nil, nil, nil, []string{"ZZLM PATIENTS"}, nil, nil)
...
func TestUninstallScript_HelpFrame(t *testing.T) {
	got := UninstallScript("ZZHF*1.0*1", []string{"ZZHFRT"}, nil, nil, nil, nil, nil, nil, nil, []string{"ZZHF-MAIN"}, nil)
...
func TestUninstallScript_File(t *testing.T) {
	got := UninstallScript("ZZVSLFS*1.0*1", nil, nil, nil, nil, nil, nil, nil, nil, nil, []string{"999000"})
	for _, want := range []string{
